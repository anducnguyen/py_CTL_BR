...
Nmax= 200
numx = numy = 100
# a = scipy.io.loadmat('T100100.mat')

transition_mat = mat73.loadmat('T100100.mat')['T']
a = scipy.io.loadmat('notA100')['notA']
obs = a.tolist()[0]
obs[:] = [obs - 1 for obs in obs]
notA = list(set(obs))
ini_state =[95,96,97,98,99,100,195,196,197,198,199,200]
alpha1 = 1
alpha2 = 0.6
