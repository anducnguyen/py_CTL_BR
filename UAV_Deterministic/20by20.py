...
transition_mat = a['T']
all_state = [i for i in range(400)]
obs = [210,350,50,211,351,51,212,352,52,213,353,53,214,354,54,215,355,55,196,216,236,256,316,336,356,376,16,396,36,56,76,96,176,184,204,224,244,304,324,344,364,4,384,24,44,64,84,164,205,345,45,206,346,46,207,347,47,208,348,48,209,349,49]
obs[:] = [obs - 1 for obs in obs]
notA = list(set(all_state) - set(obs))
ini_state = [20,40,19,39]
alpha1 = 1
alpha2 = 0.8
